...
ch4, ch4_ppb  = sim.simulate_ch4_stock_update(ch4_emission_lists)
ch4 = round(ch4, 2)
...
<div class="card">
    <div class="card_content">
        ...
        <div class="description">Mg CO₂ added.</div>
    </div>
</div>
""", unsafe_allow_html=True)
        elif metrics[j] == "ch4":
...
<div class="card">
    <div class="card_content">
        ...
        <div class="description">Mg CH₄ added.</div>
    </div>
</div>
""", unsafe_allow_html=True)
    ...
    <div class="card_content">
        ...
        <div class="description">Mg CH₄ (atmospheric stock)</div>
    </div>
</div>
              """, unsafe_allow_html=True)
        elif metrics[j] == "soot":
